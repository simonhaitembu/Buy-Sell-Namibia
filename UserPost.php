...
<div class="container">
    <div class="row">
      ...
      <form action="UserPost.php" method="post" enctype="multipart/form-data" role="form" name="BidForm">
            ...
            <div class="form-group">
              ...
              <button id="signupSubmit" input type="submit" name="submit" value="SUBMIT" class="btn btn-info btn-block"  onclick ="return ValidateBidForm();">Add Now</button>
            </div>
