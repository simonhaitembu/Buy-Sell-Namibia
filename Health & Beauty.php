...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>&nbsp&nbspHealth & Beauty</b><span class="caret"></span></a>
...
$conn = mysqli_connect($dbServername, $dbUsername, $dbPassword, $dbName); 
    ...
    $query="select * from product where CatagoryName='Health & Beauty' and ProductStatus='No' ";
    $Result=mysqli_query($conn,$query);
    $break=0;
