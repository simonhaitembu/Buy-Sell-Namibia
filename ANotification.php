   ...
   while ($row=mysqli_fetch_array($Result))
    {
          ...
          echo "</td>";
            ...
            $email=$row[1];
            $name=$row[0];
         echo"<a href=javascript:reply('$name')> <img src='Image/reply.png'  width='50px' height='50px' alt='Bid'/> </a>";
          echo "</td>";

           echo "<td>";
            $email=$row[1];
         echo"<a href=javascript:del('$email')> <img src='Image/Delete.png'  width='50px' height='50px' alt='Bid'/> </a>";
          echo "</td>";
