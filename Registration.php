...
if (isset($_POST['submit'])) {
  ...
  $query = "insert into users (Name,UserName,Password,Email,Phone,Gender,DOB,Address,Photo) value ('$name','$uname','$password','$email','$phone','$gender','$dob','$address','$destination')";
		...
		<div class="container">
			<div class="row main">
				...
				<h3>User Registration Form</h5>
					<form action="Registration.php" method="post" enctype="multipart/form-data" name="Registerform"  onsubmit="return RegisterValid();" >
