...
<div class="container-fluid" align="centre">
   <form  form action="AddAdmin.php" method="post"name="AAdmin"> 
      <div class="row">      
      ...
      <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
              <input type="submit" name="submit" value="SUBMIT" class="btn btn-default regbutton" onclick=" return validadmin();" >
            </div>   
      </div>    
    </form>
</div>
