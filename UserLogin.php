    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <form form action="UserLogin.php" method="post" name="UserLogin" onsubmit="return ValidUser();">
                <input type="text" class="form-control" name="uname" placeholder="Enter User Name">
                <input type="password" class="form-control" name="Pass" placeholder="Password">

                <button class="btn btn-lg btn-primary btn-block" input type="submit" name="submit" value="SUBMIT">Sign in</button>
