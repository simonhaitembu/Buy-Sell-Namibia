    ...
    if($datenow >= $duedate){
      ...
      $result2=mysqli_query($conn,$qry2);
          ...
          $bphone=$row2['Phone'];
            ...
            $message=" YOU WON <br>Congratulation Mr.".$sname.",<br> Product: ".$ProductName."<br> Seller ".$bname." You can contact with Buyer by Email:".$bemail." or Phone:".$bphone.".";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>&nbsp&nbspElectronics</b><span class="caret"></span></a>
...
$conn = mysqli_connect($dbServername, $dbUsername, $dbPassword, $dbName); 
    ...
    $query="select * from product where CatagoryName='Electronics' and ProductStatus='No' ";
    $Result=mysqli_query($conn,$query);
    $break=0;
