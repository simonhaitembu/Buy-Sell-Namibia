...
<?php 
     ...
     $Pass=$_POST['Pass'];
      ...
      $Complete=mysqli_query($conn,$query) or die("unable to connect");
      ...
      <div class="col-sm-6 col-md-4 col-md-offset-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form role="form" form action="Adminlogin.php" method="post" name="AdminLogin" onsubmit=" return validadmin();">
              <fieldset>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                    ...
                    <div class="form-group">
                      <input type="submit" name="submit" value="SUBMIT"class="btn btn-lg btn-primary btn-block" value="Sign in">
                    </div>
                  </div>
                </div>
              </fieldset>
